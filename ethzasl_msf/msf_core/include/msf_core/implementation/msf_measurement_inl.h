...
void MSF_MeasurementBase<EKFState_T>::CalculateAndApplyCorrection(
  ...
  P = 0.5 * (P + P.transpose());
 ROS_INFO("calculate S K P");
  core.ApplyCorrection(state, correction_);
  ROS_INFO("CalculateAndApplyCorrection");
}
...
void MSF_MeasurementBase<EKFState_T>::CalculateAndApplyCorrection(
  ...
  // Make sure P stays symmetric.
  P = 0.5 * (P + P.transpose());
 ROS_INFO("calculate S K P2");
  core.ApplyCorrection(state, correction_);
  ROS_INFO("CalculateAndApplyCorrection2");
}
...
void MSF_MeasurementBase<EKFState_T>::CalculateAndApplyCorrectionRelative(
  ...
  ROS_INFO("CalculateAndApplyCorrectionRelative");
}
